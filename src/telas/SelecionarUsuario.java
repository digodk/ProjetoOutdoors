...
public class SelecionarUsuario extends JDialog {
  ...
  private static Usuario usuarioEditado;
  private static JComboBox<Usuario> cbsUsuario;
  ...
  private static void editarDados(ActionEvent e) {
    Usuario usuario = cbsUsuario.getItemAt(cbsUsuario.getSelectedIndex());
  ...
  private SelecionarUsuario() {
    ...
    // Outdoor
    cbsUsuario = Usuario.getComboBox();
    // Botões
