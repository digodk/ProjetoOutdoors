...
public class CadastroAlugueis extends JDialog {
  ...
  private static JComboBox<Outdoor> cbxOutdoor;
  private static JTextArea txtObservacoes;
  private static Aluguel aluguelCadastrado, aluguelEmCadastro;
  private static int numDias;
  private static double valor;
  private static String observacao;
  private static Outdoor outdoor;
  ...
  private static void lerInputs() {
    ...
    outdoor = Outdoor.getListaOutdoors().get(cbxOutdoor.getSelectedIndex());
  ...
  private static void salvarDados(ActionEvent e) {
    ...
    if (inputsOK()) {
      ...
      aluguelCadastrado = Aluguel.cadastrar(aluguelEmCadastro);
  ...
  public static Aluguel cadastrar() {
    return cadastrar(new Aluguel());
  }

  public static Aluguel cadastrar(Aluguel alu) {
    if (!telaCarregada) {
      try {
    ...
    int index = alu.getOutdoor() == null ? 0 : Outdoor.getListaOutdoors().indexOf(alu.getOutdoor());
  ...
  private CadastroAlugueis() {
    ...
    cbxOutdoor = Outdoor.getComboBox();
